...
Shiny Express is a new way of writing Shiny apps that's intended to be easier to learn and quicker to write. It is especially appropriate for beginners and for simple apps.
...
```default
pip install git+https://github.com/rstudio/rsconnect-python@shiny-express
```
